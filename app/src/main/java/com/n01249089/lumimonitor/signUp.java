    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String chkUser = email.getText().toString();
                if (chkUser.trim().equals("")) {
                    Toast.makeText(signUp.this, "Please enter an email address", Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                if (!String.valueOf(confirmPassword.getText().toString()).equals(String.valueOf(password.getText().toString()))) {
                    Toast.makeText(signUp.this, "Sorry, Passwords do not match", Toast.LENGTH_SHORT).show();
                } else {
                    createNewUser(String.valueOf(email.getText()), String.valueOf(password.getText()));
                    Toast.makeText(signUp.this, "Account is being Registered", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
