...
public class Firebase_Humidity extends AppCompatActivity  {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_firebase_humidity);
            this.setTitle("Humidity Graph");
        ...
        private void drawGraph() {
            ...
            desc.setText("Humidity history from Firebase");
            desc.setTextSize(15);
        ...
        private void setupTitleandHomeButton() {
            getSupportActionBar().setSubtitle("Firebase Humidity");
