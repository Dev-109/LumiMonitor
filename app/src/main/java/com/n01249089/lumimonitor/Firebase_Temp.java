...
public class Firebase_Temp extends AppCompatActivity {
    ...
    private void drawGraph() {
        ...
        desc.setText("Temperature history from Firebase");
        desc.setTextSize(15);
       ...
       // int i =0;
        ...
        for (DataStructure ds: firebaseData){
            ...
            Entry a = new Entry(j++, Float.parseFloat(ds.getTemp()));
            //entrylist.add(e);
            entrylist.add(a);
        }
        ...
        recentPostsQuery.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildChanged(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                if (dataSnapshot != null && dataSnapshot.getValue() != null) {
                   ...
                   dataStructure.setTemp(dataSnapshot.getValue(DataStructure.class).getTemp());
//                    dataStructure.setHumidity(dataSnapshot.getValue(DataStructure.class).getHumidity());
//                    dataStructure.setLightLevel(dataSnapshot.getValue(DataStructure.class).getLightLevel());
//                    dataStructure.setMicIn(dataSnapshot.getValue(DataStructure.class).getMicIn());
//                    dataStructure.setMicOut(dataSnapshot.getValue(DataStructure.class).getMicOut());
                    String timestamp = dataSnapshot.getValue(DataStructure.class).getTimestamp();
//                    dataStructure.setRgb(dataSnapshot.getValue(DataStructure.class).getRgb());
